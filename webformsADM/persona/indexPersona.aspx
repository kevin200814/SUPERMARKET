...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="obsPersona">
        ...
        <asp:TemplateField >
        <ItemTemplate>
        <asp:HyperLink ID="btnActualizar" onClick="btnActualizar_Click" runat="server" NavigateUrl='<%#"~/Vistas/ManttoPersona.aspx?ID_PERSONA"+Eval("ID_PERSONA")%>'>
    ...
    <br />
    <asp:LinkButton ID="btnNuevo" NavigateUrl='<%#"~/Vistas/ManttoPersona.aspx?ID_PERSONA"+Eval("ID_PERSONA")%>' onClick="btnNuevo_Click" Text="Nuevo" runat="server">
