...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="obsCargoLaboral">
        ...
        <asp:TemplateField >
        <ItemTemplate>
        <asp:HyperLink ID="btnActualizar" onClick="btnActualizar_Click" runat="server" NavigateUrl='<%#"~/webformsADM/persona/ManttoCargoLaboral.aspx?ID_CARGO_LABORAL"+Eval("ID_CARGO_LABORAL")%>'>
