<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Principal.master" AutoEventWireup="true" CodeFile="IndexCargoLaboral.aspx.cs" Inherits="Vistas_IndexCargoLaboral" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="obsCargoLaboral">
        ...
        <asp:TemplateField >
        <ItemTemplate>
        <asp:HyperLink ID="btnActualizar" onClick="btnActualizar_Click" runat="server" NavigateUrl='<%#"~/webformsADM/ManttoCargoLaboral.aspx?ID_CARGO_LABORAL"+Eval("ID_CARGO_LABORAL")%>'>
     ...
     <br />
    <asp:LinkButton ID="btnNuevo" NavigateUrl='<%#"~/webformsADM/ManttoCargoLaboral.aspx?ID_TIPO_PRODUCTO"+Eval("ID_TIPO_PRODUCTO")%>' onClick="btnNuevo_Click" Text="Nuevo" runat="server">
