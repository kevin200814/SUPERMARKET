            ...
            <div class="form-horizontal">
                ...
                <div class="form-group"> 
                    <div class="col-md-10">
                        ...
                        <asp:TextBox ID="txtCodProd" class="form-control" Rows="5" runat="server" placeholder="Ingrese el Nombre del producto"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <asp:TextBox ID="txtNombreProd" class="form-control" Rows="5"  runat="server"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <asp:TextBox ID="txtDescrip" TextMode="Multiline" Placeholder="Descripcion del producto" class="form-control" Rows="5"  runat="server"></asp:TextBox>
                    </div>
                </div>
               <div class="form-group">
