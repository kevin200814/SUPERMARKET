<%@ Page Title="" Language="C#" MasterPageFile="~/Template/PrincipClient.master" AutoEventWireup="true" CodeFile="IndexPais.aspx.cs" Inherits="IndexPais" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Button ID="btnNuevo" OnClick="btnNuevoPais_Click" runat="server" Text="Nuevo pais" CssClass="btn btn-primary"/>
    <br />
