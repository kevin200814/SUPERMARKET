<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Principal.master" AutoEventWireup="true" CodeFile="indexEmpleado.aspx.cs" Inherits="Vistas_indexEmpleado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="obsEmpleado">
        ...
        <asp:TemplateField >
        <ItemTemplate>
        <asp:HyperLink ID="btnActualizar" onClick="btnActualizar_Click" runat="server" NavigateUrl='<%#"~/webformsADM/ManttoEmpleado.aspx?ID_EMPLEADO"+Eval("ID_EMPLEADO")%>'>
    ...
    <br />
    <asp:LinkButton ID="btnNuevo" NavigateUrl='<%#"~/webformsADM/ManttoEmpleado.aspx?ID_EMPLEADO"+Eval("ID_EMPLEADO")%>' onClick="btnNuevo_Click" Text="Nuevo" runat="server">
