...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="odsProveedor">
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:HyperLink ID="btnActualizar" NavigateUrl='<%#"~/webformsADM/producto/MantProveedor.aspx?ID_TIPO_PROOVEEDOR="+ Eval("ID_PROVEEDOR")%>' runat="server">Editar</asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateField>
