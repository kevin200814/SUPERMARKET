...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="obsPersona">
        <Columns>
            ...
            <asp:TemplateField >
            <ItemTemplate>
            <asp:LinkButton ID="btnEliminar" CommandArgument='<%#Eval("ID_PERSONA") %>' onClick="btnEliminar_Click" Text="Eliminar" runat="server">
        ...
        <asp:TemplateField >
        <ItemTemplate>
        <asp:HyperLink ID="btnActualizar" onClick="btnActualizar_Click" runat="server" NavigateUrl='<%#"~/webformsADM/ManttoPersona.aspx?ID_PERSONA"+Eval("ID_PERSONA")%>'>
    ...
    <br />
    <asp:LinkButton ID="btnNuevo" NavigateUrl='<%#"~/webformsADM/ManttoPersona.aspx?ID_PERSONA"+Eval("ID_PERSONA")%>' onClick="btnNuevo_Click" Text="Nuevo" runat="server">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
      <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
      <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
      </svg>Nuevo Producto</asp:LinkButton>
    <br />
    <asp:ObjectDataSource ID="obsPersona" runat="server" SelectMethod="MostrarTodos" TypeName="PERSONA_BLL"></asp:ObjectDataSource>
